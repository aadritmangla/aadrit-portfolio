...
const ReelItem = ({ reel, isActive, onClick, index, activeIndex }: { reel: any; isActive: boolean; onClick: () => void; index: number; activeIndex: number; key?: React.Key }) => {
      ...
      <div className="relative w-full h-full">
        <video 
          ...
          onError={(e) => {
            ...
            video.parentElement?.classList.add('bg-warm-beige');
          }}
        />
